    ...
    <div className="footer relative w-full h-auto">
        <div className="container-footer w-full grid pt-10 pb-10">
            <div className="ml-10">
                ...
                <p className=""><b>SMK Generasi Emas Nusantara </b>ialah tempat dimana pendidikan berkualitas dan 
        ...
        <div className="copyRightText w-full text-white">
            <p className="">Copyright © 2024 | All Right Reserved by SMK Generasi Emas Nusantara.</p>
        </div>
        </div>
