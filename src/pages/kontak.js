    ...
    return (
      ...
      <div className="mr-10 text-blue-950">
              ...
              <div className="">
                ...
                <p className="my-3">✉️ generasiemasnusantara@gmail.com</p>
                ...
                <p className="mt-20 text-blue-950"><b>SMK Generasi Emas Nusantara </b>ialah tempat dimana pendidikan berkualitas dan 
